        ...
        def process_relations(data, journal_id, invoice_date=False):
            ...
            for d in data.values():
                ...
                line_vals.append((0, 0, {
                    ...
                    'end_date': d['F_D_E_RECO'] if d['F_D_E_RECO'] not in ['30/12/1899', '1899-12-30'] else invoice_date,
                    'start_date': d['F_D_S_RECO'] if d['F_D_S_RECO'] not in ['30/12/1899', '1899-12-30'] else invoice_date,
                    'quantity': d['QUANTITY'],
